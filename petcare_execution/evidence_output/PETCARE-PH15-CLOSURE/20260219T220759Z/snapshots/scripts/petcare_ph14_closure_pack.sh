...
echo "=============================================="
echo "PetCare PH14 CLOSURE PACK"
echo "pack=${PACK_ID}"
...
status = "PASS" if (pytest_rc == 0 and preflight_rc == 0) else "FAIL"

manifest = {
  "pack_id": pack_id,
  "phase": "PH14",
  "name": "CI-Grade Governance Hardening Closure Pack",
  "status": status,
  "timestamp_utc": ts,
  "repo_root": repo_root,
  "out_dir": out,
