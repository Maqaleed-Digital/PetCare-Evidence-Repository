...
PACK_ID="PETCARE-PHASE-1-BUILD-EP12-INTELLIGENT-OPERATIONS-AND-DECISION-SUPPORT-STAGE0"
...
find \
  "petcare_execution/EP12_STAGE0" \
  "scripts/petcare_ep12_stage0_architecture_lock.sh" \
...
for rel in [
    "petcare_execution/EP12_STAGE0/EP12_ARCHITECTURE_LOCK.md",
    "petcare_execution/EP12_STAGE0/EP12_HARD_GATES.md",
    "petcare_execution/EP12_STAGE0/EP12_DEPENDENCY_MAP.md",
    "petcare_execution/EP12_STAGE0/EP12_EXECUTION_SPEC.md",
    "petcare_execution/EP12_STAGE0/EP12_NOTION_EXECUTION_MAP.md",
    "scripts/petcare_ep12_stage0_architecture_lock.sh",
]:
    path = repo_root / rel
    entries.append(
...
printf 'GOVERNANCE_POSITION  : intelligent_operations_planning_locked\n' | tee -a "${RUN_DIR}/summary.txt"
