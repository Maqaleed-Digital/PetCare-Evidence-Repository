...
PACK_ID="PETCARE-PHASE-1-BUILD-EP09-FINANCIAL-OPERATIONS-AND-RECONCILIATION-STAGE0"
...
find \
  "petcare_execution/EP09_STAGE0" \
  "scripts/petcare_ep09_stage0_architecture_lock.sh" \
...
for rel in [
    "petcare_execution/EP09_STAGE0/EP09_ARCHITECTURE_LOCK.md",
    "petcare_execution/EP09_STAGE0/EP09_HARD_GATES.md",
    "petcare_execution/EP09_STAGE0/EP09_DEPENDENCY_MAP.md",
    "petcare_execution/EP09_STAGE0/EP09_EXECUTION_SPEC.md",
    "petcare_execution/EP09_STAGE0/EP09_NOTION_EXECUTION_MAP.md",
    "scripts/petcare_ep09_stage0_architecture_lock.sh",
]:
    path = repo_root / rel
    entries.append(
...
printf 'GOVERNANCE_POSITION  : financial_operations_planning_locked\n' | tee -a "${RUN_DIR}/summary.txt"
