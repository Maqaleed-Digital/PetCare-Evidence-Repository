import type { EmergencyKpi } from "@/types/emergency";

interface EmergencyKpiStripProps {
  kpis: EmergencyKpi[];
}

const VARIANT_STYLES: Record<EmergencyKpi["variant"], string> = {
...
export function EmergencyKpiStrip({ kpis }: EmergencyKpiStripProps) {
  return (
