    ...
    <main className="stack">
      ...
      <div className="grid cols2">
        <div className="role-card" data-list-region="pharmacy-validated-prescriptions">
          ...
          <span className="muted" data-list-empty="">{isAr ? 'القائمة فارغة' : 'Queue empty'}</span>
        </div>
        <div className="role-card" data-list-region="pharmacy-safety-checks">
          <div className="role-card-icon">
            <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <span className="muted" data-list-empty="">{isAr ? 'لا توجد تنبيهات نشطة' : 'No active alerts'}</span>
        </div>
        <div className="role-card" data-list-region="pharmacy-cold-chain">
          <div className="role-card-icon">
            <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <span className="muted" data-list-empty="">{isAr ? 'لا توجد عناصر سلسلة باردة' : 'No cold-chain items'}</span>
        </div>
        <div className="role-card" data-list-region="pharmacy-dispense-log">
          <div className="role-card-icon">
            <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <span className="muted" data-list-empty="">{isAr ? 'لا توجد عمليات صرف بعد' : 'No dispenses yet'}</span>
        </div>
      </div>
