...
from deliveries import InMemoryDeliveryRepository
...
class Persistence:
    ...
    #: FR-02 (MVC-BUILD-RUNNER-001 U2): durable, tenant-scoped pet profiles.
    pets: Any = None
    ...
    messages: Any = None
    #: FR-13 (U8): multi-location stock movement ledger.
    inventory: Any = None
    ...
    #: FR-16 (U12): cold-chain deliveries, temperature logs, alerts.
    deliveries: Any = None
    #: FR-19 (U13): batch recalls and owner recall notices.
    recalls: Any = None
    #: FR-20 (U14): tenant prices, COD orders, collections, receipts.
    orders: Any = None
    ...
    *,
    ...
    if mode == MODE_MEMORY:
        ...
        return Persistence(
            ...
            deliveries=InMemoryDeliveryRepository(tenants),
    ...
    return Persistence(
        ...
        deliveries=PostgresDeliveryRepository(pool),
